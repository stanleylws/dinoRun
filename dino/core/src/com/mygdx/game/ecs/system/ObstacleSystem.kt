...
import com.mygdx.game.SCROLL_SPEED_TO_WORLD_RATIO
...
private const val MAX_SPAWN_INTERVAL = 7f
private const val MIN_SPAWN_INTERVAL = 4f
...
class ObstacleSystem(
    ...
    override fun update(deltaTime: Float) {
        ...
        if (spawn && spawnTime <= 0f) {
            ...
            spawnObstacle(if (Math.random() > 0.7) ObstacleType.BOX else ObstacleType.TRAP)
        }
    }
